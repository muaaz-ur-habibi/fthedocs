...
if '--settings' in argv:
    ...
    cons.clear()
    pyfiglet.print_figlet("F__kTheDocs", font="diet_cola", width=400)
    cons.rule("[italic]F***THEDOCS", style="rule.bar")
...
try:
    with cons.status("[bold underline yellow]Building collection of docs", spinner='betaWave') as status:
